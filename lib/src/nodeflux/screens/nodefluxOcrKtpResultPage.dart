...
class NodefluxOcrKtpResultPage extends StatefulWidget {
  ...
  @override
  _NodefluxOcrKtpResultPageState createState() =>
      _NodefluxOcrKtpResultPageState();
}
...
class _NodefluxOcrKtpResultPageState extends State<NodefluxOcrKtpResultPage> {
  ...
  TextEditingController scheduledDateTimeController =
  ...
  setup() {
    ...
    birthdateController =
        TextEditingController(text: widget.model.tanggal_lahir);
    birthplaceController =
        TextEditingController(text: widget.model.tempat_lahir);
    ...
    maritalStatusController =
        TextEditingController(text: widget.model.status_perkawinan);
    ...
    bloodTypeController =
        TextEditingController(text: widget.model.golongan_darah);
    kabupatenKotaController =
        TextEditingController(text: widget.model.kabupaten_kota);
    kelurahanDesaController =
        TextEditingController(text: widget.model.kelurahan_desa);
    nationalityController =
        TextEditingController(text: widget.model.kewarganegaraan);
            ...
            ? Column(
                ...
                children: <Widget>[
                  RaisedButton(
                    ...
                    child: Text('Submit registration data',
